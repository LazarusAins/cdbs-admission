...
//   };
    ...
    const handleLogin = () => {
      ...
      // return
      login({body: formData}).then((response) => {
        if(response === 401){
          Swal.fire({
            icon: "error",
...
//   };}
  ...
  useEffect(() => {
    ...
    console.log("SESSION TOKE FROM LOGIN: ", sessionToken)

    if (sessionToken !== null) {
      handleSessionToken().then(() => {
        console.log("HANDLE SESSION SUCCESS")
        navigate('/dashboard')
      })
    }
  }, []);
      ...
      <Modal show={verificationError} id="modal-container" centered>
        ...
        <Modal.Body>
          <div className="verification-box">
            ...
            <hr />
            <button onClick={handleVerifyEmail} className="btn btn-blue">
